@echo off
TITLE Toolbox Tecnico Pro - Iniciando...
net session >nul 2>&1
if %errorLevel% neq 0 (
    powershell -Command "Start-Process '%~f0' -Verb RunAs"
    exit /b
)
powershell -NoProfile -ExecutionPolicy Bypass -Command "Get-Content '%~f0' | Select-Object -Skip 10 | Out-String | Invoke-Expression"
exit /b
:: --- INICIO DEL CODIGO POWERSHELL ---
# =========================================================
# TOOLBOX TECNICO PRO - By Viktor (V9.0 Portable BAT Edition)
# =========================================================

# --- 0. PROTOCOLOS Y SEGURIDAD ---
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12

# --- 1. FOCO DE VENTANA POST-UAC ---
