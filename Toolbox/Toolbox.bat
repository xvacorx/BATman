...
@echo off
setlocal
title Toolbox Tecnico Pro - By Viktor [Offline]

:: --- 1. AUTO-ELEVACION A ADMINISTRADOR ---
net session >nul 2>&1
if %errorLevel% neq 0 (
    echo [-] Sin permisos de administrador. Solicitando acceso...
    powershell -Command "Start-Process -FilePath '%0' -Verb RunAs"
    exit /b
)

:: Ejecuta el bloque PowerShell embebido debajo
...
# --- 2. CONFIGURACION DE VENTANA Y COLORES ---
...
# --- 3. FUNCIONES DE INTERFAZ CENTRADA ---
...
# --- 4. ACCIONES (LAS 13 HERRAMIENTAS) ---
$actions = @{
